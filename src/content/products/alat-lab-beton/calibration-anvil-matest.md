---
name: "Calibration Anvil Matest"
category: "alat-lab-beton"
image: "https://placehold.co/600x600/F8F9FA/1F2124?text=Calibration%20Anvil%20Matest"
...
**Calibration Anvil Matest** adalah instrumen pengujian vital untuk kebutuhan laboratorium teknik sipil maupun lapangan. Alat ini didesain memenuhi standar internasional (ASTM) dan nasional (SNI) untuk menjamin akurasi data proyek konstruksi Anda.
...
| :--- | :--- |
| **Model** | Calibration Anvil Matest |
| **Dimensi** | - |
| **Berat** | - |
| **Power** | - |
