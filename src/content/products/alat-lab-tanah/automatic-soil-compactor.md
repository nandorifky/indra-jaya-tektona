---
name: "Automatic Soil Compactor"
category: "alat-lab-tanah"
image: "https://placehold.co/600x600/F8F9FA/1F2124?text=Automatic%20Soil%20Compactor"
...
**Automatic Soil Compactor** adalah instrumen pengujian vital untuk kebutuhan laboratorium teknik sipil maupun lapangan. Alat ini didesain memenuhi standar internasional (ASTM) dan nasional (SNI) untuk menjamin akurasi data proyek konstruksi Anda.
...
| :--- | :--- |
| **Model** | Automatic Soil Compactor |
| **Dimensi** | - |
| **Berat** | - |
| **Power** | - |
