...
image: "https://placehold.co/600x600/F8F9FA/1F2124?text=Dynamic%20Cone%20Penetrometer%20DCP"
...
**Dynamic Cone Penetrometer DCP** adalah instrumen pengujian vital untuk kebutuhan laboratorium teknik sipil maupun lapangan. Alat ini didesain memenuhi standar internasional (ASTM) dan nasional (SNI) untuk menjamin akurasi data proyek konstruksi Anda.
...
| :--- | :--- |
| **Model** | Dynamic Cone Penetrometer DCP |
| **Dimensi** | - |
| **Berat** | - |
| **Power** | - |
